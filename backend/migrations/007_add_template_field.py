"""Migration 007: Add template field to songs table.

This migration adds a template field that stores the user's visual style choice
(abstract, environment, character, minimal) for video generation.
"""
...
def migrate() -> None:
    """Add template field to songs table if it doesn't exist."""
