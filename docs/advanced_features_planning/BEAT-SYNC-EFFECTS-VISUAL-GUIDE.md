...
- Effects **rotate** through different types: flash → color_burst → zoom_pulse →
  brightness_pulse → glitch → repeat
...
3. The system will automatically save:
   - **Pre-effects version**: `comparison_videos/no_effects_<video_name>.mp4`
     (pure AI-generated, no FFmpeg effects)
