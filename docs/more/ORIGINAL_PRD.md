...
**Note:** This PRD was created at the start of the project and helped get us started. The product vision has evolved since then, and some features or approaches described here may differ from the current implementation.
