"""Migration 005: Add character_pose_b_s3_key field to songs table.

This migration adds the character_pose_b_s3_key field to support template characters
with multiple poses (pose-a and pose-b).
"""
...
def migrate() -> None:
    """Add character_pose_b_s3_key field to songs table if it doesn't exist."""
    ...
    field_name = "character_pose_b_s3_key"
