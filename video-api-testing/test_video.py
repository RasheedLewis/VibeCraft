...
def generate_video(
    ...
    print(f"⚙️  Parameters: {num_frames} frames @ {fps} fps, {width}x{height}")
    if seed:
        print(f"🌱 Seed: {seed}")
    print()
...
Examples:
  ...
  python test_video.py "Neon lights in Tokyo" --model minimax/hailuo-2.3 --num-frames 144
  python test_video.py "Abstract shapes floating" --seed 42 --width 1024 --height 576
    ...
    parser.add_argument("--num-frames", type=int, default=144, help="Number of frames (default: 144 for 6s @ 24fps)")
