"""Migration 006: Add total_generation_cost_usd field to songs table.

This migration adds the total_generation_cost_usd field to track estimated costs
for video generation per song.
"""
...
def migrate() -> None:
    """Add total_generation_cost_usd field to songs table if it doesn't exist."""
    ...
    field_name = "total_generation_cost_usd"
    field_type = "FLOAT"
